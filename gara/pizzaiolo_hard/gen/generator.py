...
if __name__ == "__main__":
    ...
    if TYPE == 3:
        # Only C
        # We need N distinct values for C.
        # Deck has values 1..N.
        # So we just take C1..CN?
        # Hand is random subset? Or all?
        # "player gets N cards".
        # If Deck N = Input N, player gets all C cards? 
        # "5 players... randomly distributed".
        # If Input N = 100. Deck has 500 cards (100 C, 100 D...).
        # Player gets 100 cards.
        # Can player get 100 C cards? Yes.
        # So we generate N distinct values for C.
        ...
        # So values are 1..N.
        # If Only C, we take all C cards?
        # C1...CN.
        vals = list(range(1, n + 1))
        random.shuffle(vals)
        cards = [f"C{v}" for v in vals]
